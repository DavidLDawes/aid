...
export default function SelectShipPanel({ onNewShip, onLoadShip }) {
    ...
    const createDefaultShips = () => {
        ...
        const defaultScout = {
            ...
            weapons: [],
            defenses: [],
            berths: [{ berth_type: 'staterooms', quantity: 2, mass: 4, cost: 0.5 }],
            facilities: [],
        ...
        const defaultTrader = {
            ...
            engines: [
                { engine_type: 'power_plant', drive_code: 'A', performance: 1, mass: 4, cost: 8 },
                { engine_type: 'jump_drive', drive_code: 'A', performance: 1, mass: 10, cost: 20 },
                { engine_type: 'maneuver_drive', drive_code: 'A', performance: 1, mass: 2, cost: 4 }
            ],
            fittings: [
                { fitting_type: 'bridge', mass: 10, cost: 2 },
                { fitting_type: 'comms_sensors', comms_sensors_type: 'standard', mass: 0, cost: 0 }
            ...
            weapons: [],
            defenses: [],
            berths: [{ berth_type: 'staterooms', quantity: 5, mass: 4, cost: 1 }],
            facilities: [],
            cargo: [{ cargo_type: 'cargo_bay', tonnage: 132, cost: 0 }],
            vehicles: [],
            drones: [],
            createdAt: new Date(),
            updatedAt: new Date()
