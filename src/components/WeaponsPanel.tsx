...
import { WEAPON_TYPES, BAY_WEAPON_TYPES, getWeaponMountLimit, getMaxBayWeapons, getAvailableBayWeapons } from '../data/constants';
...
const WeaponsPanel: React.FC<WeaponsPanelProps> = ({
  ...
  const spinalMountUsage = 0; // No spinal mounts on megastructures
