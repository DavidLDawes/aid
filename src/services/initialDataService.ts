...
class InitialDataService {
  ...
  // Restores the standard ships (Large Liner, Destroyer) to their baseline
  // designs, whether the user deleted or changed them - unconditionally,
  ...
  // touches those standard names; any other ship the user has added is
  // left completely alone. Used by the in-app "Reset Ships" action
  // (SelectShipPanel).
