...
describe('Initial Data Service', () => {
    ...
    beforeEach(() => {
        ...
        databaseService.initialize.mockResolvedValue(undefined);
        databaseService.hasAnyShips.mockResolvedValue(false);
        databaseService.saveOrUpdateShipByName.mockResolvedValue(1);
    ...
    describe('loadInitialDataIfNeeded', () => {
        it('should return false if database already has ships', async () => {
            databaseService.hasAnyShips.mockResolvedValue(true);
        ...
        it('should handle errors during ship loading', async () => {
            databaseService.saveOrUpdateShipByName.mockRejectedValue(new Error('Save failed'));
